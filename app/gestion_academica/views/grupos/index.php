                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="/grupos/horarios/<?php echo $grupo['id']; ?>" class="btn btn-outline-info" data-bs-toggle="tooltip" title="Ver Horarios">
                                    <i class="bi bi-calendar-week"></i>
                                </a>
                                <button class="btn btn-outline-danger" data-bs-toggle="tooltip" title="Eliminar" onclick="confirmDelete(<?php echo $grupo['id']; ?>)">
