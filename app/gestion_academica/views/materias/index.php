                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="/materias/grupos/<?php echo $materia['id']; ?>" class="btn btn-outline-info" data-bs-toggle="tooltip" title="Ver Grupos">
                                    <i class="bi bi-collection"></i>
                                </a>
                                <button class="btn btn-outline-danger" data-bs-toggle="tooltip" title="Eliminar" onclick="confirmDelete(<?php echo $materia['id']; ?>)">
